...
#define IImageMatcher_CreateAbsoluteMap(This,imgData,width,height,channels,l1PdfPath,l2PdfPath,dpi,useL2,options,jsonResult,success)	\
    ( (This)->lpVtbl -> CreateAbsoluteMap(This,imgData,width,height,channels,l1PdfPath,l2PdfPath,dpi,useL2,options,jsonResult,success) ) 
